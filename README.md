...
![Yakumo 八云酱出品](https://cdn.bayun.org/image/yakumo-one.jpg)

## fancybox

主题已经集成fancybox功能，点击图片可以放大查看，并且可以用通过鼠标和键盘方向键浏览文章所有图片。

![Yakumo 八云酱出品](https://cdn.bayun.org/image/yakumo-two.jpg)

在后台MarkDown编辑的时候注意不能简单地用图片形式插入，需要在图片外再加一层链接，比如像下面这样。

```markdown
[![Yakumo 八云酱出品](https://cdn.bayun.org/image/yasuko.jpg)](https://cdn.bayun.org/image/yasuko.jpg)
```
...
![Yakumo 八云酱出品](https://cdn.bayun.org/image/yakumo-three.jpg)

## 标签云

底部标签云默认会生成最多50个标签，如果需要修改标签数量，请修改index.php文件和archive.php文件内如下位置。

![Yakumo 八云酱出品](https://cdn.bayun.org/image/yakumo-four.jpg)
