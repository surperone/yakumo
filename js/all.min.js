        ...
        this.each(function() {
            ...
            function() {
                if (!this.loaded) {
                    ...
                    var o = e.attr("data-" + i.data_attribute); (o.indexOf("cdn.bayun.org") > -1) && (1 == i.advanced_load && (o += "?"), 1 == i.webP_load && (o += "x-oss-process=image/format,webp"), 1 != i.webP_load && (o += "x-oss-process=image/format,jpg"), 1 == i.is_scale && (o += "/resize,w_" + i.scale_width)),
                    $("<img />").bind("load",
                    function() {
                        e.hide(),
